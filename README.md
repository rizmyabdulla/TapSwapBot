...
## [Settings](https://github.com/rizmyabdulla/TapSwapBot/blob/main/.env-example)
| Настройка                | Описание                                                                                 |
|--------------------------|------------------------------------------------------------------------------------------|
...
## Installation
You can download [**Repository**](https://github.com/rizmyabdulla/TapSwapBot) by cloning it to your system and installing the necessary dependencies:
```shell
~ >>> git clone https://github.com/rizmyabdulla/TapSwapBot.git
~ >>> cd TapSwapBot

# If you are using Telethon sessions, then clone the "converter" branch
~ >>> git clone https://github.com/rizmyabdulla/TapSwapBot.git -b converter
~ >>> cd TapSwapBot
